...
public enum DomainErrorCode {
    ...
    POINT_WALLET_NOT_FOUND(HttpStatus.BAD_REQUEST, "POINT_WALLET_NOT_FOUND", "포인트 지갑을 찾을 수 없습니다"),
    POINT_INSUFFICIENT(HttpStatus.BAD_REQUEST, "POINT_INSUFFICIENT", "보유 포인트가 부족합니다"),
