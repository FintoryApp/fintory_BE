...
public class KoreanStockRankServiceImpl implements KoreanStockRankService {
    ...
    private Mono<Void> processStockRankData(String code, String token) {
        return  kisWebClient.get()
                ...
                .header("custtype", "P")
                .retrieve()
                .bodyToMono(KoreanStockRankDataWrapper.class)
    ...
    private void processStockRank(){
        List<StockRank> marketCapRankList = stockRankRepository.findAllOrderByMarketCap("KRW");
        List<StockRank> rocRankList = stockRankRepository.findAllOrderByRocRate("KRW");
        List<StockRank> tradingVolumeRankList = stockRankRepository.findAllOrderByTradingVolume("KRW");
